          ...
          <div className="flex-1 overflow-hidden">
            {submitted ? (
              <div className="flex flex-col justify-center items-center px-8 py-16 h-full text-center">
                <div className="flex justify-center items-center bg-[#C9A84C] mb-6 w-16 h-16 font-bold text-[#1C1336] text-2xl">âœ“</div>
  ...
  return (
    <div className="border-neutral-100 last:border-0 border-b">
      <button onClick={() => setOpen(!open)} className="flex justify-between items-center gap-4 py-5 w-full text-left">
        <span className="font-bold text-[#1C1336] text-sm">{q}</span>
...
const AgencyPage: React.FC = () => {
  ...
  return (
    <div className="bg-white pt-16 sm:pt-20 min-h-screen font-sans antialiased">
            ...
            <div>
              ...
              <div className="flex sm:flex-row flex-col gap-4">
                <button
                  ...
                  className="inline-flex justify-center items-center gap-2 bg-[#C9A84C] hover:bg-[#b8933e] px-8 py-3.5 font-mono font-bold text-[#1C1336] text-xs uppercase tracking-wider transition-colors duration-200"
                >
                  Request Services
                  <ArrowRight size={14} />
                </button>
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="font-bold text-[#1C1336] group-hover:text-[#4B1E91] text-sm leading-snug transition-colors">
                    {cat.label}
                  </p>
            ...
            <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
              <div className={`grid lg:grid-cols-2 gap-12 lg:gap-16 items-start ${!isEven ? 'lg:grid-flow-dense' : ''}`}>
                ...
                <div className={!isEven ? 'lg:col-start-2' : ''}>
                  ...
                  <h2 className="mb-6 font-black text-[#1C1336] text-3xl sm:text-4xl uppercase leading-tight">
                    {cat.title}
                  </h2>
                  ...
                  <div className="space-y-2 mb-8">
                    {cat.services.map((s) => (
                      <div key={s.name} className="flex justify-between items-center bg-white px-4 py-3 border border-neutral-100">
                        <span className="font-bold text-[#1C1336] text-sm">{s.name}</span>
                  ...
                  {/* Disclaimer */}
                  {cat.disclaimer && (
                    <div className="bg-[#1C1336]/4 mb-6 px-4 py-3 border-neutral-300 border-l-2">
                  ...
                  <button
                    ...
                    style={{ backgroundColor: cat.color, color: cat.color === '#C9A84C' ? '#1C1336' : '#ffffff' }}
                  >
                    Request {cat.tagline}
                    <ArrowRight size={14} />
                  </button>
      ...
      <section className="bg-[#1C1336] py-20 text-white">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
      ...
      <div className="bg-[#C9A84C] py-20">
        <div className="mx-auto px-6 max-w-4xl text-center">
          <p className="mb-4 font-mono text-[#1C1336]/60 text-xs uppercase tracking-widest">Ready to Get Started?</p>
          <h2 className="mb-4 font-black text-[#1C1336] text-3xl sm:text-4xl uppercase leading-tight">
            Get the Financial Support You Deserve.
          </h2>
          <p className="mx-auto mb-8 max-w-xl text-[#1C1336]/70 text-sm leading-relaxed">
          ...
          <div className="flex sm:flex-row flex-col justify-center gap-4">
            <button
              ...
              className="inline-flex justify-center items-center gap-2 bg-[#1C1336] hover:bg-[#1E0A4A] px-8 py-4 font-mono font-bold text-white text-xs uppercase tracking-wider transition-colors duration-200"
            >
              Request Services
              <ArrowRight size={14} />
            </button>
            <Link
              to="/contact"
              className="inline-flex justify-center items-center gap-2 hover:bg-[#1C1336]/5 px-8 py-4 border border-[#1C1336]/30 hover:border-[#1C1336] font-mono text-[#1C1336] text-xs uppercase tracking-wider transition-colors duration-200"
            >
              Have Questions? Contact Us
            </Link>
          </div>
          <p className="mt-8 font-mono text-[#1C1336]/40 text-xs">
            The Emerson Agency LLC is not a licensed financial advisor, CPA, or insurance agency.
            All services are education-centered. <Link to="/disclaimer" className="hover:text-[#1C1336]/70 underline">Read full disclaimer.</Link>
          </p>
        </div>
      </div>
