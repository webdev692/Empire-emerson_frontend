...
const Contact: React.FC = () => {
  ...
  return (
    <div id="contact" className="bg-white pt-16 sm:pt-20 min-h-screen font-sans antialiased">
      ...
      {/* ── Hero ── */}
      <div className="bg-[#1C1336] px-6 sm:px-10 lg:px-16 py-24">
      ...
      <div className="mx-auto px-6 sm:px-10 lg:px-16 py-20 max-w-7xl">
        <div className="gap-16 grid lg:grid-cols-2">
          ...
          {/* ── Left: Info ── */}
          <div>
            <h2 className="mb-4 font-bold text-[#1C1336] text-[28px] sm:text-[36px] uppercase leading-tight heading">
              We're Here to Help.
            </h2>
            <p className="mb-10 text-[#1C1336]/55 text-[16px] sm:text-lg leading-[1.9]">
                  ...
                  >
                    ...
                    <div>
                      ...
                      {ch.href ? (
                        ...
                        <p className="font-bold text-[#1C1336] text-[13px]">{ch.value}</p>
                      )}
                      <p className="mt-1 text-[#1C1336]/45 text-[13px] leading-relaxed">{ch.description}</p>
                    </div>
                  </motion.div>
                );
              })}
            ...
            {submitted ? (
              ...
              >
                <div className="flex justify-center items-center bg-[#C9A84C] mb-6 w-16 h-16">
                  <Check size={28} className="text-[#1C1336]" strokeWidth={3} />
                </div>
                <h3 className="mb-3 font-bold text-[#1C1336] text-2xl uppercase heading">Message Sent!</h3>
                <p className="mb-8 max-w-sm text-[#1C1336]/55 text-[14px] leading-relaxed">
