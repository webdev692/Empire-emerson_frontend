  ...
  return (
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-6">
        <h1 className="text-3xl font-bold text-[#1C1336] mb-4">Service registration</h1>
        ...
        <div className="mb-6">
          ...
          <div className="mt-2 font-semibold text-[#1C1336]">{service || '— pick a service from the Services page'}</div>
        </div>
