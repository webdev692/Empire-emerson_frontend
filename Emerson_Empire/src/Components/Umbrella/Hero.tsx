      ...
      <div className="relative flex lg:flex-row flex-col-reverse items-center gap-12 lg:gap-16 mx-auto px-6 sm:px-10 lg:px-16 py-14 lg:py-20 max-w-7xl">
        ...
        <div className="flex flex-col justify-center lg:w-1/2 text-left">
          ...
          <div className="mb-6 inline-flex w-fit px-4 py-2 rounded-full border border-[#C9A84C]/30 bg-[#C9A84C]/5">
            <span className="font-semibold text-gold-on-light text-xs uppercase tracking-[0.15em]">
              ★ Welcome
            </span>
          </div>
          ...
          >
            ...
            <span className="block text-gold-on-light">The Emerson Empire</span>
          </h1>

          {/* Gold line — star — gold line */}
          <div className="flex items-center gap-3 mb-7">
            <span className="bg-[#C9A84C] w-14 h-px" />
            <span className="text-gold-on-light text-sm leading-none">★</span>
            <span className="bg-[#C9A84C] w-14 h-px" />
          </div>
          ...
          <div className="gap-6 grid grid-cols-3 max-w-md">
            {FEATURES.map(({ icon: Icon, title, subtitle }) => (
              <div key={title}>
                <Icon className="mb-2 text-gold-on-light" size={22} strokeWidth={1.5} />
                <p
                  className="font-bold text-gold-on-light text-xs uppercase tracking-[0.15em]"
                  style={{ fontFamily: "var(--font-label)" }}
                >
                  {title}
                </p>
