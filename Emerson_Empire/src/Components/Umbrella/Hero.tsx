      ...
      <div className="flex lg:flex-row flex-col-reverse items-center gap-12 lg:gap-16 mx-auto px-6 sm:px-10 lg:px-16 py-12 max-w-7xl">
        ...
        <div className="flex flex-col justify-center lg:w-1/2 text-left">
          ...
          <div className="relative flex items-center mb-6">
            ...
            {/* Label centered on top of the lines â€” no background so lines cross through */}
            <p
          ...
          <div className="flex items-center gap-4">
            ...
            {/* <a
              href="/contact"
              className="inline-flex items-center bg-white hover:bg-[#FEFBEA] px-6 py-3 border border-[#C9A84C] rounded-sm font-semibold text-[#12022A] text-sm uppercase tracking-[0.12em] transition-colors duration-200"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              Contact Us
            </a> */}
