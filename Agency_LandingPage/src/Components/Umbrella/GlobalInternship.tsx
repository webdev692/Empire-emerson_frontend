...
const TrackCard: React.FC<(typeof TRACKS)[0] & { open: boolean; onToggle: () => void }> = ({
  ...
  >
    {/* Card header image */}
    <div className="relative h-44 overflow-hidden bg-[#0A1128]">
    ...
    <div className="bg-white border border-neutral-100">
      {submitted ? (
        <div className="flex flex-col items-center justify-center py-20 px-8 text-center">
          <div className="flex items-center justify-center w-16 h-16 bg-[#C9A84C] text-[#0A1128] text-2xl font-bold mb-6">
            ✓
          </div>
          <h3 className="font-bold text-[#0A1128] text-2xl uppercase mb-3">Application Submitted!</h3>
...
const FAQItem: React.FC<{ q: string; a: string }> = ({ q, a }) => {
  ...
  return (
    <div className="border-b border-neutral-100 last:border-0">
      ...
      >
        <span className="font-bold text-[#0A1128] text-sm pr-4">{q}</span>
        <ChevronDown
          size={16}
    ...
    <div className="pt-16 sm:pt-20 min-h-screen bg-[#FAFAF9] font-sans antialiased">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-16 py-24 max-w-7xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#C9A84C] hover:bg-[#b8933e] px-8 py-4 font-mono font-bold text-[#0A1128] text-xs uppercase tracking-wider transition-colors duration-200"
            >
              Apply Now — It's Free
              <ArrowRight size={14} />
            </a>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-black text-[#0A1128] text-2xl sm:text-3xl uppercase leading-tight mb-4">
            ...
            <div className="relative">
              ...
              />
              <div className="absolute bottom-4 left-4 right-4 bg-[#0A1128]/90 px-4 py-3">
      ...
      <section id="tracks" className="py-20 scroll-mt-20">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <h2 className="font-black text-[#0A1128] text-2xl sm:text-3xl uppercase leading-tight mb-3">
            Choose Your Track.
          </h2>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.label} className="pl-4 border-l-2 border-[#4B1E91]/30">
                    <p className="font-bold text-[#0A1128] text-sm mb-1">{item.label}</p>
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-[#C9A84C]/25 p-8">
              ...
              <div className="inline-block px-2 py-0.5 bg-[#C9A84C] font-mono text-[#0A1128] text-xs uppercase tracking-widest mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              <div key={title} className="bg-white p-6 border border-neutral-100">
                ...
                <h3 className="font-bold text-[#0A1128] text-sm mb-2">{title}</h3>
                <p className="text-neutral-500 text-xs leading-relaxed">{body}</p>
              </div>
            ))}
          </div>
          <div className="bg-[#0A1128] px-6 py-4 border-l-4 border-[#C9A84C]">
      ...
      <section className="py-20 bg-[#FAFAF9] border-t border-neutral-100">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <h2 className="font-black text-[#0A1128] text-2xl sm:text-3xl uppercase leading-tight mb-8">
